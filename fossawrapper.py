...
def Model_mod():
    ...
    print("2.  Change conductances")
    print("3.  Change Connections between states")
    print("4.  Return to Main Menu")
    selection = raw_input("Type 1-3 to make selection, and hit 'Enter'.\r")
    while selection != '1' and selection != '2' and selection != '3' and selection != '4':
        print("Invalid selection\r")
        selection = raw_input("Type 1-4 to make selection, and hit 'Enter'.\r")
    if selection == '1':
        print("Your model has the following states", states)
	print("Do you want to add or remove states?")
	print("1.  Add")
	print("2.  Remove")
	while selection != '1' and selection != '2':
	    print("Invalid selection\r")
	    selection = raw_input("Type 1-2 to make selection, and hit 'Enter'.\r")	
	if selection ==2: 
	    loop = 0
	    while loop == 0:
		var = raw_input("Please Enter the state you would like to remove\r")	
		if var in states:
		    states.remove(var)
		    loop =1
		else
		print("state not found in states.  State contains:")
		print(states)
	    
	elif selection == 1:
	    #First Gonna figure out how many open and how many closed
	    opens = 0
	    closeds = 0
	    for x in states:
		if x[0] == 'O':
		    ...
		    closeds = closeds + 1	    
	    print("Do you want to add a closed state, or an open state?")
	    print("1.  Open")
	    print("2.  Closed")
	    while selection != '1' and selection != '2':
		print("Invalid selection\r")
		...
		strnum = str(opens)
		mystring = "O" + strnum
		states.insert(opens, mystring)
		output_string = "please input Conductance of " + mystring +", a number greater than 0 and less than or equal to 1\r"
		conductance = raw_input(output_string)
		cnotset = 0
		while cnotset ==0:
		    work = 0
	...
	print("Your model has the following conductances", conductances)
	done = 0
	while done == 0:
	    var = raw_input("What state's conductance would you like to modify")
	    mykeys = conductances.keys()
	    if var in mykeys:
		done = 1
		mystring = var
	    else:
		print("That state is not present.  Please try again")
	output_string = "please input Conductance of " + mystring +", a number greater than 0 and less than or equal to 1\r"
	conductance = raw_input(output_string)
	cnotset = 0
	while cnotset ==0:
        ...
        for x in range (0, strmax):
            print(x, ", ", state[x], "\r")
	print("What is the origin of the connection you want to modify?")
	for x in range (0, strmax):
	    print(x, ", ", state[x])
	done = 0
	while done == 0:
	    var = raw_input("What state's conductance would you like to modify")
	    if var in range (0, strmax):
		done = 1
		myx = var
	    else:
		print("That state is not present.  Please try again")
	print("What is the termination of the connection you want to modify?")
	for x in range (0, strmax):
	    print(x, ", ", state[x])
	done = 0
	while done == 0:
